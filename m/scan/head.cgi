...
echo "<div class="header">"
	...
	echo "<a id="button" href="/m/net.cgi"><strong>net tools</strong></a>"
	echo "<a id="button" href="/m/mail.cgi"><strong>mail tools</strong></a>"
	echo "<a id="button" href="/m/scan.cgi"><strong>scan tools</strong></a>"
	echo "<a id="button" href="/m/geoip.cgi"><strong>geoip</strong></a>"
	echo "<a id="button" href="/m/ipcalc.cgi"><strong>ipcalc</strong></a>"
	echo "<a id="button" href="/m/headers.cgi"><strong>http head</strong></a>"
	echo "<a id="button" href="/m/url.cgi"><strong>tiny url</strong></a>"
...
cat << EOF
<div align="right">
<span style="color:#3B5999">Host:<span id="ab"> $remote_host </span>&nbsp;
Country:<span id="ab"> $country </span>&nbsp; 
City:<span id="ab"> $city </span>&nbsp; 
ASN:<span id="ab"> $asn </span></a>
</div>
EOF
...
#echo "<div id="nocode" align="center">"
